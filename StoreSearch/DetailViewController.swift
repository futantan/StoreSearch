...
class DetailViewController: UIViewController {
    ...
    func updateUI() {
        ...
        if searchResult.artistName.isEmpty {
            artistNameLabel.text = NSLocalizedString("Unknow", comment: "Localized: Unknow")
        } else {
        ...
        if searchResult.price == 0 {
            priceText = NSLocalizedString("Free", comment: "Localized: Free")
    ...
    func menuViewControllerSendSupportEmail(_: MenuViewController) {
        dismissViewControllerAnimated(true) {
            if MFMailComposeViewController.canSendMail() {
                ...
                controller.setToRecipients(["your@emial-address-here.com"])
